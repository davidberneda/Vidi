...
uses
  Windows, Classes, ExtCtrls, SysUtils;
...
type
  TCharBuffer = packed Array[0..1024*1024] of AnsiChar;
...
const
  MaxBufSize = 1024;
var
  pBuf: PCharBuffer; //i/o buffer
  iBufSize: Cardinal;
  app_spawn: PChar;

  si: {$IFDEF FPC}_STARTUPINFOA{$ELSE}_STARTUPINFOW{$ENDIF};
